...
resort1 = Resort.create(airport: airport1, user: user1, name: 'Shanghai Fenyang Boutique Hotel', continent: 'Asia', country: 'China', address: 'No.45 Fenyang Road, Xuhui, 210008 Shanghai, China', latitude: 31.212558, longitude: 121.454990, website: 'http://www.china.com/', photo: 'https://t-ec.bstatic.com/images/hotel/max1024x768/291/29136264.jpg',  description: 'China resort description')

resort2 = Resort.create(airport: airport1, user: user1, name: 'AYANA Resort and Spa, BALI', continent: 'Asia', country: 'Indonesia', address: 'Karang Mas Estate, Jalan Karang Mas Sejahtera, 80364 Jimbaran, Indonesia', latitude: -8.788849, longitude: 115.155452, website: 'http://www.indonesia.com/', photo: 'https://t-ec.bstatic.com/images/hotel/max1024x768/291/29136264.jpg', description: 'Indonesia resort description')

resort3 = Resort.create(airport: airport1, user: user1, name: 'Katathani Phuket Beach Resort', continent: 'Asia', country: 'Thailand', address: '14 Kata Noi Rd., 83100 Kata Beach, Thailand ',latitude: 7.807111, longitude: 98.299593, website: 'http://www.france.com/', photo: 'https://t-ec.bstatic.com/images/hotel/max1024x768/291/29136264.jpg', description: 'France resort description')

resort4 = Resort.create(airport: airport1, user: user1, name: 'Sokha Angkor Resort', continent: 'Asia', country: 'Cambodia', address: 'National Road No. 6 and Sivatha Street Junction, Siem Reap, Cambodia',latitude: 13.363742, longitude: 103.855918, website: 'http://www.bolivia.com/', photo: 'https://t-ec.bstatic.com/images/hotel/max1024x768/291/29136264.jpg', description: 'Bolivia resort description')

resort5 = Resort.create(airport: airport1, user: user1, name: 'Constance Moofushi', continent: 'Asia', country: 'Maldives', address: 'South Atoll, Alifu Atoll 00200, Moofushi Island, Maldives', latitude: 3.884293, longitude: 72.727770, website: 'https://www.constancehotels.com/en/hotels-resorts/maldives/moofushi/', photo: 'https://t-ec.bstatic.com/images/hotel/max1024x768/291/29136264.jpg', description: 'Upscale all-inclusive resort in the Indian Ocean')

resort6 = Resort.create(airport: airport1, user: user1, name: 'Sunway Hotel & Spa', continent: 'Asia', country: 'Malaysia', address: 'Persiaran Lagoon, Bandar Sunway, 47500 Kuala Lumpur, Malaysia', latitude: 3.072268, longitude: 101.608965, website: 'https://www.barcelo.com/en-us/royal-hideaway/hotels/mexico/riviera-maya/royal-hideaway-playacar/?utm_source=google&utm_medium=organic&utm_campaign=my_business&utm_content=h385', photo: 'https://t-ec.bstatic.com/images/hotel/max1024x768/291/29136264.jpg', description: 'Upscale, beachfront, adults-only resort')

resort7 = Resort.create(airport: airport1, user: user1, name: 'The Village Coconut Island', continent: 'Asia', country: 'Thailand', address: '51/7 Moo 6, T.KOHKAEW, Phuket 83200, Thailand', latitude: 7.938938, longitude: 98.425896, website: 'http://www.thevillage-coconutisland.com/', photo: 'https://t-ec.bstatic.com/images/hotel/max1024x768/291/29136264.jpg', description: 'Upscale beachfront resort overlooking Phang Nga Bay')

resort8 = Resort.create(airport: airport1, user: user1, name: 'Grand Coloane Resort', continent: 'Asia', country: 'China', address: '1918 Estrada de Hac Sa, Coloane, Macau, Macao', latitude: 22.125311, longitude: 113.576755, website: 'http://www.eastbedarra.com.au/', photo: 'https://t-ec.bstatic.com/images/hotel/max1024x768/291/29136264.jpg', description: 'Luxury beach villa with private pool')

resort9 = Resort.create(airport: airport1, user: user1, name: 'Jimbaran Cliffs Hotel & Spa', continent: 'Asia', country: 'Indonesia', address: 'Jalan Gedong Sari II #888, Jimbaran, 80361 Jimbaran, Indonesia', latitude: -8.790538, longitude: 115.200251, website: 'http://www.cottonhouse.net/', photo: 'https://t-ec.bstatic.com/images/hotel/max1024x768/291/29136264.jpg', description: 'Exclusive Carribean vacation spot')

resort10 = Resort.create(airport: airport1, user: user1, name: 'Pertiwi Bisma ', continent: 'Asia', country: 'Indonesia', address: 'Jl. Bisma - Ubud, 80571 Ubud, Indonesia', latitude: -8.511524, longitude: 115.258271, website: 'http://www.china.com/', photo: 'https://t-ec.bstatic.com/images/hotel/max1024x768/291/29136264.jpg', description: 'Curacao resort description')

resort11 = Resort.create(airport: airport1, user: user1, name: 'Jade Mountain', continent: 'Carribean', country: 'St Lucia', address: 'Jade Mountain Resort, St Lucia', website: 'http://www.indonesia.com/', latitude: 13.864564, longitude: -61.075653, photo: 'https://t-ec.bstatic.com/images/hotel/max1024x768/291/29136264.jpg', description: 'Indonesia resort description')

resort12 = Resort.create(airport: airport1, user: user1, name: 'Turquesa Hotel', continent: 'Carribean', country: 'Domincan Republic', address: '1Av. Anacaona 101, Santo Domingo, Dominican Republic', latitude: 18.438664, longitude: -69.969524, website: 'http://www.bolivia.com/', photo: 'https://t-ec.bstatic.com/images/hotel/max1024x768/291/29136264.jpg', description: 'Bolivia resort description')

resort13 = Resort.create(airport: airport1, user: user1, name: 'Hyatt Regency Nice Palais de la Méditerranée', continent: 'Europe', country: 'France', address: '13 Prom. des Anglais, 06000 Nice, France', latitude: 43.695300, longitude: -7.263006, website: 'http://www.bolivia.com/', photo: 'https://t-ec.bstatic.com/images/hotel/max1024x768/291/29136264.jpg', description: 'Bolivia resort description')
